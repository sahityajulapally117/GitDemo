...
public class Test3 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String https = "https://accounts.google.com/o/oauth2/v2/auth?scope=https://www.googleapis.com/auth/userinfo.email&auth_url=https://accounts.google.com/o/oauth2/v2/auth&client_id=692183103107-p0m7ent2hk7suguv4vq22hjcfhcr43pj.apps.googleusercontent.com&response_type=code&redirect_uri=https://rahulshettyacademy.com/getCourse.php&state=verifyfjdss";
		/*
		 ...
		 * "sahityajulapally9@gmail.com");
		 * driver.findElement(By.cssSelector("input[type='email']")).sendKeys(Keys.ENTER
		 * ); Thread.sleep(3000);
		 * driver.findElement(By.cssSelector("input[type='password']")).sendKeys(
		 * "Ap16cc3517.9098");
		 * driver.findElement(By.cssSelector("input[type='password']")).sendKeys(Keys.
		 * ENTER); Thread.sleep(4000); String url=driver.getCurrentUrl(); String
		 * partialcode=url.split("code=")[1]; String
		 * code=partialcode.split("&scope")[0]; System.out.println(code);
		 */
		String code = "4%2F0AfJohXkVbaX-VWWv6zy8X9-uAmNj2ICGelXK74RiHhi10rqq1uf42q6Dfk5CSaW9zmV52Q";
		...
		String gc1=given().queryParam("access_token",
				accessToken).expect().defaultParser(Parser.JSON) .when()
